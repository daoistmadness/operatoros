...
describe("academic roster candidates", () => {
  it("previews and commits a disposable roster with provenance", async () => {
    ...
    try {
      ...
      const form = new FormData(); form.append("file", new File([new Uint8Array(await workbook.xlsx.writeBuffer())], "roster.xlsx")); form.append("source_owner", "School Office"); form.append("date_received", "2026-08-26");
