new_dashboard = """import React, { useCallback, useEffect, useMemo, useState, useRef } from "react";
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <motion.div whileHover={{ y: -4 }} className="card p-6 lg:col-span-3 flex flex-col justify-between group">
          <div>
            ...
            {Array.isArray(rekapAbsensiSummary?.jenjang) && rekapAbsensiSummary.jenjang.length > 0 ? (
              <div className="space-y-6">
                ...
                {/* Visual Bar */}
                <div className="w-full h-4 rounded-full overflow-hidden flex bg-slate-100 mt-2">
        ...
        <motion.div whileHover={{ y: -4 }} className="card p-6 lg:col-span-2 flex flex-col justify-between bg-slate-900 border-slate-800 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 p-32 bg-brand/20 blur-3xl rounded-full transform translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="card p-6 md:p-8 flex flex-col">
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-xs font-bold px-3 py-1 bg-slate-100 rounded-full text-slate-500 tracking-wider">6 MONTHS</span>
          </div>
        ...
        <div className="card p-6 md:p-8 flex flex-col">
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-xs font-bold px-3 py-1 bg-emerald-50 rounded-full text-emerald-600 tracking-wider">TOP 5</span>
          </div>
