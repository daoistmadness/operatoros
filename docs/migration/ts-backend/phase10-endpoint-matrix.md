...
| --- | ---: | ---: | --- |
| OpenAPI paths | 282 | 185 | 104 unresolved operations are mapped below |
| Operations | 327 | 223 matching operations | 103 migration defects and one deprecated route remain |
| Elysia runtime routes | — | 224 | `/ready` is an Elysia-only readiness route |
...
| --- | ---: | --- | --- | --- |
| `api.analytics` | 26 | Dashboard detail, attendance-rate, management-summary, historical-trends, intervention-impact, and both legacy aliases | `MIGRATION_DEFECT` | Frontend consumers exist. Implement and replay both canonical and legacy paths. |
...
Remaining migration defects: **103**.
