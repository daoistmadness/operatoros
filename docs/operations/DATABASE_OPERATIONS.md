...
application schema is S4.6 (`20260901_s46`) and ordinary startup validates
...
adds only explicit academic-year and jenjang cutoff configuration. Future
...
Normal operation pairs current main with an S4.6 database. Until the protected
database is separately migrated, it must not be started with the S4.5
