...
application schema is S4.5 (`20260901_s45`) and ordinary startup validates
...
calendar authority tables. Future operational migrations require
...
Normal operation pairs current main with an S4.5 database. Until the protected
