...
export const ManagementReviewAttendanceExportQuerySchema = Type.Object({
  academic_year_id: Id,
  term_id: Id,
  jenjang_id: Id,
  program_id: Type.Optional(Id),
...
export const ManagementReviewProfileResponseSchema = Type.Object({
  context: Type.Object({
    ...
    termStart: Type.String(), termEnd: Type.String(), jenjangId: Type.Union([Type.Number(), Type.Null()]), programId: Type.Union([Type.Number(), Type.Null()]), classId: Type.Union([Type.Number(), Type.Null()]),
    jenjangLabel: Type.Union([Type.String(), Type.Null()]), programLabel: Type.Union([Type.String(), Type.Null()]), classLabel: Type.Union([Type.String(), Type.Null()]), generatedAt: Type.String(),
...
export type ManagementReviewAttendanceExportQuery = Static<typeof ManagementReviewAttendanceExportQuerySchema>;
