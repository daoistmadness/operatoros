...
appendRow(rosterSheet, ["NISN", "Program", "student_identifier", "student_name", "academic_year", "jenjang", "class_name", "status"]);
appendRow(rosterSheet, ["3177210228", "Primary", "999990120", "E2E Roster Preview Student", "2026/2027", "Primary", "P1A", "active"]);
appendRow(rosterSheet, ["", "Primary", "999990121", "E2E Roster P1B Student", "2026/2027", "Primary", "P1B", "active"]);
appendRow(rosterSheet, ["", "Primary", "999990122", "E2E Roster Unknown Student", "2026/2027", "Primary", "P1C", "active"]);
appendRow(rosterSheet, ["", "Primary", "999990123", "E2E Roster Inactive Student", "2026/2027", "Primary", "P1D", "active"]);
appendRow(rosterSheet, ["", "Secondary", "999990124", "E2E Roster Conflict Student", "2026/2027", "Primary", "P1A", "active"]);
appendRow(rosterSheet, ["", "Primary", "999990125", "E2E Roster Ambiguous Student", "2026/2027", "Primary", "P1a", "active"]);
