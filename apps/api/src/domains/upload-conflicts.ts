...
function rosterItem(context: AuthContext, value: Row, batch: Row): Row {
  ...
  return {
    ...
    recommended_action: ({ POSSIBLE_DUPLICATE: "Compare stable identifiers and explicitly select the existing student.", MISSING_JENJANG: "Select an active canonical Jenjang in the source roster.", MISSING_CLASS: "Select an active canonical class in the source roster.", CLASS_NOT_FOUND: "Correct the class name or academic year in the workbook.", CLASS_INACTIVE: "Select an active canonical class.", CLASS_CONTEXT_CONFLICT: "Correct the workbook level, program, or grade to match the canonical class.", AMBIGUOUS_CLASS: "Use a unique exact canonical class name.", INVALID: "Correct the invalid or duplicate source data." } as Row)[value.classification] ?? "Review the technical details; unknown classifications stay blocked.",
