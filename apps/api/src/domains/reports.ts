...
async function tardinessWorkbook(report: Row, managementOnly: boolean): Promise<Uint8Array> {
  ...
  if (!managementOnly) {
    ...
    appendRow(classes, ["Class", "Level", "Expected Student-Days", "Late Events", "Affected Students", "Total Late Minutes", "Avg Minutes Late", "Late Rate %", "Days With Late Arrivals"]);
