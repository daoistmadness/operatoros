...
import { configRoutes, systemRoutes } from "./domains/config";
import { readinessRoutes } from "./domains/readiness";
...
import { managementReviewAttendanceRoutes } from "./domains/management-review-attendance";
...
import { classOverviewRoutes } from "./domains/class-overview";
import { dailyAttendanceRoutes } from "./domains/daily-attendance";
import { attendanceCalendarRoutes } from "./domains/attendance-calendar";
import { machineAttendancePreviewRoutes } from "./domains/machine-attendance-preview";
...
export function createApp(_config: Partial<BackendConfig> = {}) {
  ...
  if (context) {
    ...
    managementReviewAttendanceRoutes(app, context);
    ...
    classOverviewRoutes(app, context);
  ...
  if (_config.environment !== "test") {
    app.use(openapi({
      ...
      documentation: context ? openApiDocumentation() : undefined,
    }));
  }
  return app;
}
