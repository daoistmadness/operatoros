...
export default function StudentTrendInsights() {
  ...
  return <div className="space-y-7">
    <PageHeader eyebrow="Management Analytics" title="Student Trends" description="Descriptive changes between comparable periods. The values do not classify students." />
