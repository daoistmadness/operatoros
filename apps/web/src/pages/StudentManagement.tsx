...
export default function StudentManagement() {
  ...
  return <div className="space-y-6">
    ...
    <Tabs defaultValue="all">
      ...
      <TabsContent value="history"><Card><CardHeader><CardTitle>Student import and update history</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-sm text-muted-foreground">Roster previews and student update workbooks are available in Data Import &amp; Export. Every commit is retained with its checksum and operator.</p>{can("import_student_roster") ? <Button onClick={() => { window.location.href = "/upload?section=roster"; }}>Open Data Import &amp; Export</Button> : <p className="text-sm font-semibold text-slate-600">An administrator manages student imports and update workbooks.</p>}</CardContent></Card></TabsContent>
    </Tabs>
