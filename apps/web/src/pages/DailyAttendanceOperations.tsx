...
export default function DailyAttendanceOperations() {
  ...
  return <div className="space-y-7">
    <PageHeader eyebrow="Attendance Operations" title="Daily Attendance" description="Review calendar expectation, attendance-recording coverage, and submission timing for one selected date. Timing is factual and does not judge staff performance." actions={<Button variant="outline" onClick={reset} className="gap-2"><RotateCcw className="size-4" aria-hidden="true" />Reset filters</Button>} />
