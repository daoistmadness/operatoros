...
const DailyAttendanceOperations = lazy(() => import('../pages/DailyAttendanceOperations'));
const AttendanceCalendar = lazy(() => import('../pages/AttendanceCalendar'));
const AttendanceMachineImportPreview = lazy(() => import('../pages/AttendanceMachineImportPreview'));
...
export const authenticatedRoutes: readonly AppRouteDefinition[] = [
  ...
  defineRoute({ path: '/attendance/machine-import', element: <AttendanceMachineImportPreview />, group: ROUTE_GROUPS.ATTENDANCE, authorization: capability('import_attendance') }),
