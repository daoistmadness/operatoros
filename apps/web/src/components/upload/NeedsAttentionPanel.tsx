    ...
    <div className="space-y-5">
      <section className="overflow-hidden rounded-2xl border border-amber-200 bg-[radial-gradient(circle_at_top_right,_rgba(251,191,36,0.22),_transparent_45%),linear-gradient(135deg,#fffdf5,#ffffff)] p-5 sm:p-7">
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          ...
          <Link className="inline-flex min-h-11 items-center justify-center gap-2 rounded-md border border-border bg-surface px-4 py-2 text-sm font-bold hover:bg-surface-muted" to="/upload?section=history"><History className="size-4" />History</Link>
        </div>
      </section>
