ALTER TABLE jenjangs ADD COLUMN IF NOT EXISTS code VARCHAR(32) NULL;
ALTER TABLE jenjangs ADD COLUMN IF NOT EXISTS level INTEGER NULL;
ALTER TABLE jenjangs ADD COLUMN IF NOT EXISTS active BOOLEAN NOT NULL DEFAULT TRUE;
...
ALTER TABLE student_enrollments
    ADD COLUMN IF NOT EXISTS academic_class_id BIGINT NULL
