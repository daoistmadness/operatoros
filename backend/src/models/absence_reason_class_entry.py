...
class AbsenceReasonClassEntry(Base):
    __tablename__ = "absence_reason_class_entries"
    ...
    __table_args__ = (
        UniqueConstraint("class_name", "month", "year", name="uq_absence_reason_class_entries_period"),
    )
