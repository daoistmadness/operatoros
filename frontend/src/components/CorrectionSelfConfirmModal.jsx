...
export default function CorrectionSelfConfirmModal({ correction, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const code = err.response?.data?.detail?.code || err.data?.detail?.code;
      const message = err.response?.data?.detail?.message || err.data?.detail?.message || err.message;
